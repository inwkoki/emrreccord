...
export const PECARN = [
  ...
  { name: "Intermediate risk", tag: "<2 yr", cls: "amber",
    ...
    items: [
      "Scalp haematoma (excluding frontal)",
      "Loss of consciousness >5 seconds",
      "Not acting normally per parent",
      "Severe mechanism: fall >3 ft · MVA with ejection/rollover/fatality · bike or pedestrian vs vehicle without helmet · struck by high-impact object",
    ],
    dispo: "Observation vs CT — shared decision-making (multiple vs isolated factors · worsening during observation · physician experience · parental preference · age <3 months)" },
  { name: "Low risk", tag: "<2 yr", cls: "green",
